        ...
        //    radioGroup = (RadioGroup) itemView.findViewById(R.id.radioGroup);
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((PrimaryBusinessActivity) context).visibleProceedButton();

                    preferences = PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext());
                    editor = preferences.edit();
                    editor.putString("catID",""+cate_id.getText());
                    editor.putString("category",""+cate_name.getText());
                    editor.commit();
//                    Toast.makeText(RecyclerViewAdapter.this.context,
...
//                    selectionState.setChecked(false);
    ...
    public void updateList(List<DataAdapter> list)
    {
        dataAdapters = list;
        notifyDataSetChanged();
    }
