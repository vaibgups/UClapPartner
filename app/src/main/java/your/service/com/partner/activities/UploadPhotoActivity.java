...
public class UploadPhotoActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {

    LinearLayout upload_photo;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload_photo = findViewById(R.id.add_photo);
    ...
    public void uploadphoto(View view) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlHelper.UPLOAD_WORK_DETAILS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("upload_multiple_image", response.toString());
                progressDialog.dismiss();
                Toast.makeText(UploadPhotoActivity.this, "Upload Images Successfully", Toast.LENGTH_SHORT).show();
            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("workDetails", "" + encodedImage);
                return hashMap;
            }
        };
