...
public class IdentityVerificationActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {

    LinearLayout upload_idProof;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload_idProof = findViewById(R.id.upload_idProof);
    ...
    public void upload_idProof(View view) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlHelper.UPLOAD_ID_PROOF, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("upload_multiple_image", response.toString());
                progressDialog.dismiss();
                Toast.makeText(IdentityVerificationActivity.this, "Upload Images Successfully", Toast.LENGTH_SHORT).show();
            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("idproof", "" + encodedImage);
                return hashMap;
            }
        };
        ...
        progressDialog = new ProgressDialog(IdentityVerificationActivity.this);
